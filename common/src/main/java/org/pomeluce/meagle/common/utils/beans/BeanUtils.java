package org.pomeluce.meagle.common.utils.beans;

import jakarta.annotation.Nullable;
import org.pomeluce.meagle.common.core.lang.Assert;
                ...
                if (sourcePd != null) {
                    ...
                    if (readMethod != null && readMethod.getReturnType().isAssignableFrom(writeMethod.getParameterTypes()[0])) {
                        ...
                        try {
                            ...
                            throw new MeagleCommonUtilException(StringUtils.format("Could not copy property {} from source to target", targetPd.getName()), e);
                        }
                    }
                }
            }
