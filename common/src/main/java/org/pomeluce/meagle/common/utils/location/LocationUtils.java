package org.pomeluce.meagle.common.utils.location;

import org.pomeluce.meagle.common.config.MeagleProperty;
import org.pomeluce.meagle.common.core.http.HttpRequest;
import org.pomeluce.meagle.common.core.http.HttpResult;
...
public class LocationUtils {
    ...
    private static final MeagleProperty.Config MEAGLE_CONFIG = MeagleProperty.instance().getConfig();
    ...
    public static String getRelativeLocation(String ip) {
        ...
        if (MEAGLE_CONFIG.isEnableLocation() && (result = HttpRequest.instance().GET(IP + "?ip=" + ip + "&json=true")).statusCode() == HttpStatus.OK.value()) {
