...
import org.akir.server.system.domain.enums.UserGender;
...
public class User extends BaseEntity {
    ...
    /* WebAuthn 用户句柄, Base64URL 编码后的唯一标识 */
    private @Column(nullable = false, unique = true) String userHandle;
    ...
    public boolean equals(Object o) {
        ...
        User user = (User) o;
        return Objects.equals(id, user.id) && Objects.equals(account, user.account) && Objects.equals(password, user.password) && Objects.equals(username, user.username) && Objects.equals(identityId, user.identityId) && Objects.equals(email, user.email) && Objects.equals(phone, user.phone) && Objects.equals(avatar, user.avatar) && gender == user.gender && status == user.status && Objects.equals(userHandle, user.userHandle) && Objects.equals(credentials, user.credentials);
    }
    ...
    public int hashCode() {
        ...
        result = 31 * result + Objects.hashCode(userHandle);
