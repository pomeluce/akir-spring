...
create or replace function akir_snowflake_id() returns bigint as
$$
declare
...
begin
    ...
    -- 获取最后记录的时间戳和序列号
    select last_timestamp, last_sequence into last_ts,last_seq from akir_snowflake_state where id = 1000000001 for update;
