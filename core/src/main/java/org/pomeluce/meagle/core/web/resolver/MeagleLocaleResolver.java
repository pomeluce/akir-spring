package org.pomeluce.meagle.core.web.resolver;
 ...
 * @className : MeagleLocaleResolver
 * @description : 国际化处理器
 */
public class MeagleLocaleResolver extends AbstractLocaleResolver {
    private final String localeHeader = MeagleEnvironment.instance.get("spring.messages.locale-header", String.class, "Accept-Language");
